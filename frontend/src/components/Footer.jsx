    ...
    <footer className={`ft-root ${themeClass}`}>
      ...
      <div className="ft-media-row">
        ...
        <div className="ft-socials">
          ...
          {/* Facebook and Pinterest links removed: both resolved to dead/wrong destinations
              per the SEO audit. Re-add once the studio's real profile URLs are confirmed. */}
        </div>
      </div>
